...
var DiscordSDKLib = (() => {
  ...
  // node_modules/@discord/embedded-app-sdk/output/_virtual/_commonjsHelpers.cjs
  var require_commonjsHelpers = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/_virtual/_commonjsHelpers.cjs"(exports) {
      "use strict";
  ...
  // node_modules/@discord/embedded-app-sdk/output/_virtual/index4.cjs
  var require_index4 = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/_virtual/index4.cjs"(exports) {
      "use strict";
  ...
  // node_modules/@discord/embedded-app-sdk/output/lib/eventemitter3/index2.cjs
  var require_index2 = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/lib/eventemitter3/index2.cjs"(exports) {
      "use strict";
      var index = require_index4();
      var hasRequiredEventemitter3;
      function requireEventemitter3() {
        if (hasRequiredEventemitter3) return index.__module.exports;
      ...
      exports.__require = requireEventemitter3;
    }
  });

  // node_modules/@discord/embedded-app-sdk/output/_virtual/index.cjs
  var require_virtual = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/_virtual/index.cjs"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      var _commonjsHelpers = require_commonjsHelpers();
      var index = require_index2();
      var eventemitter3Exports = index.__require();
      var EventEmitter = /* @__PURE__ */ _commonjsHelpers.getDefaultExportFromCjs(eventemitter3Exports);
      exports.default = EventEmitter;
    }
  });

  // node_modules/@discord/embedded-app-sdk/output/lib/zod/lib/index.cjs
  var require_lib = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/lib/zod/lib/index.cjs"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      exports.util = void 0;
      (function(util) {
      ...
      var ZodParsedType = exports.util.arrayToEnum([
        "string",
        "nan",
        "number",
        "integer",
      ...
      var ZodIssueCode = exports.util.arrayToEnum([
        "invalid_type",
        "invalid_literal",
        "custom",
        "invalid_union",
  ...
  // node_modules/@discord/embedded-app-sdk/output/_virtual/BigInteger2.cjs
  var require_BigInteger2 = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/_virtual/BigInteger2.cjs"(exports) {
      "use strict";
  ...
  // node_modules/@discord/embedded-app-sdk/output/lib/big-integer/BigInteger.cjs
  var require_BigInteger = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/lib/big-integer/BigInteger.cjs"(exports) {
      "use strict";
      var BigInteger = require_BigInteger2();
      var hasRequiredBigInteger;
      function requireBigInteger() {
        if (hasRequiredBigInteger) return BigInteger.__module.exports;
        ...
        return BigInteger.__module.exports;
      }
      exports.__require = requireBigInteger;
    }
  });

  // node_modules/@discord/embedded-app-sdk/output/_virtual/BigInteger.cjs
  var require_BigInteger3 = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/_virtual/BigInteger.cjs"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      var _commonjsHelpers = require_commonjsHelpers();
      var BigInteger = require_BigInteger();
      var BigIntegerExports = BigInteger.__require();
      var bigInt = /* @__PURE__ */ _commonjsHelpers.getDefaultExportFromCjs(BigIntegerExports);
      exports.default = bigInt;
    }
  });

  // node_modules/@discord/embedded-app-sdk/output/utils/BigFlagUtils.cjs
  var require_BigFlagUtils = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/utils/BigFlagUtils.cjs"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      var BigInteger = require_BigInteger3();
      var MAX_BIG_INT = 64;
      var SMALL_INT = 16;
  ...
  // node_modules/@discord/embedded-app-sdk/output/Constants.cjs
  var require_Constants = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/Constants.cjs"(exports) {
      "use strict";
      var BigFlagUtils = require_BigFlagUtils();
      exports.RPCCloseCodes = void 0;
      (function(RPCCloseCodes) {
        RPCCloseCodes[RPCCloseCodes["CLOSE_NORMAL"] = 1e3] = "CLOSE_NORMAL";
        ...
        RPCCloseCodes[RPCCloseCodes["INVALID_CLIENTID"] = 4e3] = "INVALID_CLIENTID";
      ...
      (function(RPCErrorCodes) {
        RPCErrorCodes[RPCErrorCodes["INVALID_PAYLOAD"] = 4e3] = "INVALID_PAYLOAD";
        RPCErrorCodes[RPCErrorCodes["INVALID_COMMAND"] = 4002] = "INVALID_COMMAND";
        RPCErrorCodes[RPCErrorCodes["INVALID_GUILD"] = 4003] = "INVALID_GUILD";
        RPCErrorCodes[RPCErrorCodes["INVALID_EVENT"] = 4004] = "INVALID_EVENT";
        RPCErrorCodes[RPCErrorCodes["INVALID_CHANNEL"] = 4005] = "INVALID_CHANNEL";
        RPCErrorCodes[RPCErrorCodes["INVALID_PERMISSIONS"] = 4006] = "INVALID_PERMISSIONS";
        RPCErrorCodes[RPCErrorCodes["INVALID_CLIENTID"] = 4007] = "INVALID_CLIENTID";
        RPCErrorCodes[RPCErrorCodes["INVALID_ORIGIN"] = 4008] = "INVALID_ORIGIN";
        RPCErrorCodes[RPCErrorCodes["INVALID_TOKEN"] = 4009] = "INVALID_TOKEN";
        RPCErrorCodes[RPCErrorCodes["INVALID_USER"] = 4010] = "INVALID_USER";
  ...
  // node_modules/@discord/embedded-app-sdk/output/utils/zodUtils.cjs
  var require_zodUtils = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/utils/zodUtils.cjs"(exports) {
      "use strict";
  ...
  // node_modules/@discord/embedded-app-sdk/output/generated/schemas.cjs
  var require_schemas = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/generated/schemas.cjs"(exports) {
      "use strict";
      var index = require_lib();
      var zodUtils = require_zodUtils();
      var InitiateImageUploadResponseSchema = index.default.object({ image_url: index.default.string() }).describe('Response for "INITIATE_IMAGE_UPLOAD" Command');
      var OpenShareMomentDialogRequestSchema = index.default.object({ mediaUrl: index.default.string().max(1024) }).describe('Request for "OPEN_SHARE_MOMENT_DIALOG" Command');
      var AuthenticateRequestSchema = index.default.object({ access_token: index.default.union([index.default.string(), index.default.null()]).optional() }).describe('Request for "AUTHENTICATE" Command');
      var AuthenticateResponseSchema = index.default.object({
        ...
        scopes: index.default.array(zodUtils.fallbackToDefault(index.default.enum([
          "identify",
          "identify.premium",
          "email",
          "connections",
        ...
        ]).or(index.default.literal(-1)).default(-1))),
      ...
      var GetActivityInstanceConnectedParticipantsResponseSchema = index.default.object({
        participants: index.default.array(index.default.object({
          ...
          avatar_decoration_data: index.default.union([
      ...
      var ShareInteractionRequestSchema = index.default.object({
        ...
        content: index.default.string().max(2e3).optional(),
        ...
        components: index.default.array(index.default.object({
          ...
          components: index.default.array(index.default.object({
            ...
            custom_id: index.default.string().max(100).describe("Developer-defined identifier for the button; max 100 characters").optional()
          })).max(5).optional()
        })).optional(),
        pid: index.default.number().optional()
      }).describe('Request for "SHARE_INTERACTION" Command');
      var ShareInteractionResponseSchema = index.default.object({ success: index.default.boolean() }).describe('Response for "SHARE_INTERACTION" Command');
      var ShareLinkRequestSchema = index.default.object({
        custom_id: index.default.string().max(64).optional(),
        message: index.default.string().max(1e3),
        link_id: index.default.string().max(64).optional()
      }).describe('Request for "SHARE_LINK" Command');
      var ShareLinkResponseSchema = index.default.object({ success: index.default.boolean(), didCopyLink: index.default.boolean(), didSendMessage: index.default.boolean() }).describe('Response for "SHARE_LINK" Command');
      var GetRelationshipsResponseSchema = index.default.object({
        relationships: index.default.array(index.default.object({
          ...
          presence: index.default.object({
            status: index.default.string(),
            activity: index.default.union([
              index.default.object({
      ...
      var InviteUserEmbeddedRequestSchema = index.default.object({ user_id: index.default.string(), content: index.default.string().min(0).max(1024).optional() }).describe('Request for "INVITE_USER_EMBEDDED" Command');
      var GetUserRequestSchema = index.default.object({ id: index.default.string().max(64) }).describe('Request for "GET_USER" Command');
      var GetUserResponseSchema = index.default.union([
        index.default.object({
          id: index.default.string(),
          username: index.default.string(),
          global_name: index.default.union([index.default.string(), index.default.null()]).optional(),
      ...
      var GetQuestEnrollmentStatusRequestSchema = index.default.object({ quest_id: index.default.string() }).describe('Request for "GET_QUEST_ENROLLMENT_STATUS" Command');
      var GetQuestEnrollmentStatusResponseSchema = index.default.object({ quest_id: index.default.string(), is_enrolled: index.default.boolean(), enrolled_at: index.default.union([index.default.string(), index.default.null()]).optional() }).describe('Response for "GET_QUEST_ENROLLMENT_STATUS" Command');
      var QuestStartTimerRequestSchema = index.default.object({ quest_id: index.default.string() }).describe('Request for "QUEST_START_TIMER" Command');
      var QuestStartTimerResponseSchema = index.default.object({ success: index.default.boolean() }).describe('Response for "QUEST_START_TIMER" Command');
      var GetQuestResponseSchema = index.default.object({
      ...
      var RequestProxyTicketRefreshResponseSchema = index.default.object({ ticket: index.default.string() }).describe('Response for "REQUEST_PROXY_TICKET_REFRESH" Command');
      ...
      var emptyResponseSchema = index.default.object({}).optional().nullable();
      var emptyRequestSchema = index.default.void();
      var Schemas = {
  ...
  // node_modules/@discord/embedded-app-sdk/output/schema/common.cjs
  var require_common = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/schema/common.cjs"(exports) {
      "use strict";
      var index = require_lib();
      var zodUtils = require_zodUtils();
      ...
      (function(Commands) {
        ...
        Commands["GET_QUEST"] = "GET_QUEST";
        Commands["GET_QUEST_ENROLLMENT_STATUS"] = "GET_QUEST_ENROLLMENT_STATUS";
        ...
        Commands["QUEST_START_TIMER"] = "QUEST_START_TIMER";
        Commands["REQUEST_PROXY_TICKET_REFRESH"] = "REQUEST_PROXY_TICKET_REFRESH";
        Commands["SHARE_INTERACTION"] = "SHARE_INTERACTION";
        Commands["SHARE_LINK"] = "SHARE_LINK";
      })(exports.Commands || (exports.Commands = {}));
      var ReceiveFramePayload = index.object({
        cmd: index.string(),
        data: index.unknown(),
        evt: index.null(),
        nonce: index.string()
      }).passthrough();
      var ScopesObject = Object.assign(Object.assign({}, schemas.AuthenticateResponseSchema.shape.scopes.element.overlayType._def.innerType.options[0].Values), { UNHANDLED: -1 });
      var Scopes = zodUtils.zodCoerceUnhandledValue(ScopesObject);
      var Relationship = schemas.GetRelationshipsResponseSchema.shape.relationships.element;
      var User = index.object({
        id: index.string(),
      ...
      var GuildMemberRPC = index.object({
      ...
      var UserVoiceState = index.object({
        mute: index.boolean(),
        nick: index.string(),
        user: User,
      ...
      var Status = zodUtils.zodCoerceUnhandledValue(StatusObject);
      var Activity = index.object({
        name: index.string(),
        type: index.number(),
        ...
        details_url: index.string().url().optional().nullable(),
        state: index.string().optional().nullable(),
        state_url: index.string().url().optional().nullable(),
        ...
        assets: index.object({
          ...
          large_url: index.string().url().optional().nullable(),
          small_image: index.string().nullable(),
          small_text: index.string().nullable(),
          small_url: index.string().url().optional().nullable()
        }).partial().optional().nullable(),
      ...
      var PermissionOverwrite = index.object({
        id: index.string(),
      ...
      var PresenceUpdate = index.object({
        user: User,
        guild_id: index.string(),
        status: Status,
      ...
      var ChannelMention = index.object({
        id: index.string(),
        guild_id: index.string(),
        type: index.number(),
        name: index.string()
      });
      var Attachment = index.object({
        id: index.string(),
      ...
      var EmbedProvider = index.object({
        name: index.string().optional().nullable(),
        url: index.string().optional().nullable()
      });
      var EmbedAuthor = index.object({
        name: index.string().optional().nullable(),
        url: index.string().optional().nullable(),
        icon_url: index.string().optional().nullable(),
        proxy_icon_url: index.string().optional().nullable()
      });
      var EmbedField = index.object({
        name: index.string(),
        value: index.string(),
        inline: index.boolean()
      });
      var Embed = index.object({
      ...
      var Reaction = index.object({
        count: index.number(),
        me: index.boolean(),
        emoji: Emoji
      });
      var MessageActivity = index.object({
        type: index.number(),
        party_id: index.string().optional().nullable()
      });
      var MessageApplication = index.object({
        id: index.string(),
      ...
      var VoiceSettingsMode = index.object({
      ...
      var VoiceSettingsIO = index.object({
      ...
      var CertifiedDevice = index.object({
      ...
      var OrientationLockState = zodUtils.zodCoerceUnhandledValue(OrientationLockStateTypeObject);
      ...
      var ThermalState = zodUtils.zodCoerceUnhandledValue(ThermalStateTypeObject);
      var OrientationTypeObject = {
        UNHANDLED: -1,
        PORTRAIT: 0,
        LANDSCAPE: 1
      };
      var Orientation = zodUtils.zodCoerceUnhandledValue(OrientationTypeObject);
      ...
      var LayoutMode = zodUtils.zodCoerceUnhandledValue(LayoutModeTypeObject);
  ...
  // node_modules/@discord/embedded-app-sdk/output/schema/events.cjs
  var require_events = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/schema/events.cjs"(exports) {
      "use strict";
      var index = require_lib();
      ...
      (function(Events) {
        ...
        Events["ACTIVITY_JOIN"] = "ACTIVITY_JOIN";
        Events["QUEST_ENROLLMENT_STATUS_UPDATE"] = "QUEST_ENROLLMENT_STATUS_UPDATE";
      })(exports.Events || (exports.Events = {}));
      var DispatchEventFrame = common.ReceiveFramePayload.extend({
      ...
      var ErrorEvent = common.ReceiveFramePayload.extend({
      ...
      var EventFrame = index.union([DispatchEventFrame, OtherEvent, ErrorEvent]);
      ...
      var EventSchema = {
        ...
        [exports.Events.ACTIVITY_JOIN]: {
          payload: DispatchEventFrame.extend({
            evt: index.literal(exports.Events.ACTIVITY_JOIN),
            data: index.object({
              applicationId: index.string(),
              secret: index.string()
            })
          })
        },
        [exports.Events.QUEST_ENROLLMENT_STATUS_UPDATE]: {
          payload: DispatchEventFrame.extend({
            evt: index.literal(exports.Events.QUEST_ENROLLMENT_STATUS_UPDATE),
            data: index.object({
              quest_id: index.string(),
              is_enrolled: index.boolean(),
              enrolled_at: index.string().date()
            })
          })
        }
      };
  ...
  // node_modules/@discord/embedded-app-sdk/output/utils/assertUnreachable.cjs
  var require_assertUnreachable = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/utils/assertUnreachable.cjs"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
  ...
  // node_modules/@discord/embedded-app-sdk/output/schema/responses.cjs
  var require_responses = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/schema/responses.cjs"(exports) {
      "use strict";
      var index = require_lib();
      var common = require_common();
      var zodUtils = require_zodUtils();
      var schemas = require_schemas();
      var assertUnreachable = require_assertUnreachable();
      var EmptyResponse = index.object({}).nullable();
      var AuthorizeResponse = index.object({
        code: index.string()
      });
      var GetGuildsResponse = index.object({
        guilds: index.array(index.object({
          id: index.string(),
          name: index.string()
        }))
      });
      var GetGuildResponse = index.object({
        id: index.string(),
        name: index.string(),
        icon_url: index.string().optional(),
        members: index.array(common.GuildMember)
      });
      var GetChannelResponse = index.object({
        id: index.string(),
      ...
      var GetChannelsResponse = index.object({
      ...
      var VoiceSettingsResponse = index.object({
      ...
      var SubscribeResponse = index.object({
        evt: index.string()
      });
      var CaptureShortcutResponse = index.object({ shortcut: common.ShortcutKey });
      var SetActivityResponse = common.Activity;
      var GetSkusResponse = index.object({ skus: index.array(common.Sku) });
      var GetEntitlementsResponse = index.object({ entitlements: index.array(common.Entitlement) });
      var StartPurchaseResponse = index.array(common.Entitlement).nullable();
      var SetConfigResponse = index.object({
        use_interactive_pip: index.boolean()
      });
      var UserSettingsGetLocaleResponse = index.object({
        locale: index.string()
      });
      var EncourageHardwareAccelerationResponse = index.object({
        enabled: index.boolean()
      });
      var GetChannelPermissionsResponse = index.object({
        permissions: index.bigint().or(index.string())
      });
      var OpenExternalLinkResponse = zodUtils.fallbackToDefault(index.object({ opened: index.boolean().or(index.null()) }).default({ opened: null }));
      var GetPlatformBehaviorsResponse = index.object({
        iosKeyboardResizesView: index.optional(index.boolean())
      });
      var ResponseFrame = common.ReceiveFramePayload.extend({
        cmd: index.nativeEnum(common.Commands),
        evt: index.null()
      });
      function parseResponseData({ cmd, data }) {
        switch (cmd) {
          ...
          case common.Commands.GET_QUEST:
          case common.Commands.GET_QUEST_ENROLLMENT_STATUS:
          case common.Commands.GET_RELATIONSHIPS:
          case common.Commands.GET_USER:
          case common.Commands.INITIATE_IMAGE_UPLOAD:
          case common.Commands.INVITE_USER_EMBEDDED:
          case common.Commands.OPEN_SHARE_MOMENT_DIALOG:
          case common.Commands.QUEST_START_TIMER:
          case common.Commands.REQUEST_PROXY_TICKET_REFRESH:
          case common.Commands.SHARE_INTERACTION:
          case common.Commands.SHARE_LINK:
      ...
      exports.OpenExternalLinkResponse = OpenExternalLinkResponse;
  ...
  // node_modules/@discord/embedded-app-sdk/output/schema/index.cjs
  var require_schema = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/schema/index.cjs"(exports) {
      "use strict";
      var index = require_lib();
      ...
      var ClosePayload = index.object({
        code: index.number(),
        message: index.string().optional()
      });
      var IncomingPayload = index.object({
  ...
  // node_modules/@discord/embedded-app-sdk/output/utils/commandFactory.cjs
  var require_commandFactory = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/utils/commandFactory.cjs"(exports) {
      "use strict";
      var index = require_lib();
      var common = require_common();
      var schemas = require_schemas();
  ...
  // node_modules/@discord/embedded-app-sdk/output/commands/authorize.cjs
  var require_authorize = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/commands/authorize.cjs"(exports) {
      "use strict";
      var common = require_common();
      var responses = require_responses();
      var commandFactory = require_commandFactory();
      var authorize = (sendCommand) => commandFactory.commandFactory(sendCommand, common.Commands.AUTHORIZE, responses.AuthorizeResponse);
      exports.authorize = authorize;
    }
  });

  // node_modules/@discord/embedded-app-sdk/output/commands/captureLog.cjs
  var require_captureLog = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/commands/captureLog.cjs"(exports) {
      "use strict";
      var common = require_common();
      var responses = require_responses();
      var commandFactory = require_commandFactory();
      var captureLog = (sendCommand) => commandFactory.commandFactory(sendCommand, common.Commands.CAPTURE_LOG, responses.EmptyResponse);
      exports.captureLog = captureLog;
    }
  });

  // node_modules/@discord/embedded-app-sdk/output/commands/encourageHardwareAcceleration.cjs
  var require_encourageHardwareAcceleration = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/commands/encourageHardwareAcceleration.cjs"(exports) {
      "use strict";
      var common = require_common();
      var responses = require_responses();
      var commandFactory = require_commandFactory();
      var encourageHardwareAcceleration = (sendCommand) => commandFactory.commandFactory(sendCommand, common.Commands.ENCOURAGE_HW_ACCELERATION, responses.EncourageHardwareAccelerationResponse);
      exports.encourageHardwareAcceleration = encourageHardwareAcceleration;
    }
  });

  // node_modules/@discord/embedded-app-sdk/output/commands/getChannel.cjs
  var require_getChannel = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/commands/getChannel.cjs"(exports) {
      "use strict";
      var common = require_common();
      var responses = require_responses();
      var commandFactory = require_commandFactory();
      var getChannel = (sendCommand) => commandFactory.commandFactory(sendCommand, common.Commands.GET_CHANNEL, responses.GetChannelResponse);
      exports.getChannel = getChannel;
    }
  });

  // node_modules/@discord/embedded-app-sdk/output/commands/getEntitlements.cjs
  var require_getEntitlements = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/commands/getEntitlements.cjs"(exports) {
      "use strict";
      var common = require_common();
      var responses = require_responses();
      var commandFactory = require_commandFactory();
      var getEntitlements = (sendCommand) => commandFactory.commandFactory(sendCommand, common.Commands.GET_ENTITLEMENTS_EMBEDDED, responses.GetEntitlementsResponse);
      exports.getEntitlements = getEntitlements;
    }
  });

  // node_modules/@discord/embedded-app-sdk/output/commands/getSkus.cjs
  var require_getSkus = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/commands/getSkus.cjs"(exports) {
      "use strict";
      var common = require_common();
      var responses = require_responses();
      var commandFactory = require_commandFactory();
      var getSkus = (sendCommand) => commandFactory.commandFactory(sendCommand, common.Commands.GET_SKUS_EMBEDDED, responses.GetSkusResponse);
      exports.getSkus = getSkus;
    }
  });

  // node_modules/@discord/embedded-app-sdk/output/commands/getChannelPermissions.cjs
  var require_getChannelPermissions = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/commands/getChannelPermissions.cjs"(exports) {
      "use strict";
      var common = require_common();
      var responses = require_responses();
      var commandFactory = require_commandFactory();
      var getChannelPermissions = (sendCommand) => commandFactory.commandFactory(sendCommand, common.Commands.GET_CHANNEL_PERMISSIONS, responses.GetChannelPermissionsResponse);
      exports.getChannelPermissions = getChannelPermissions;
    }
  });

  // node_modules/@discord/embedded-app-sdk/output/commands/getPlatformBehaviors.cjs
  var require_getPlatformBehaviors = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/commands/getPlatformBehaviors.cjs"(exports) {
      "use strict";
      var common = require_common();
      var responses = require_responses();
      var commandFactory = require_commandFactory();
      var getPlatformBehaviors = (sendCommand) => commandFactory.commandFactory(sendCommand, common.Commands.GET_PLATFORM_BEHAVIORS, responses.GetPlatformBehaviorsResponse);
      exports.getPlatformBehaviors = getPlatformBehaviors;
    }
  });

  // node_modules/@discord/embedded-app-sdk/output/commands/openExternalLink.cjs
  var require_openExternalLink = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/commands/openExternalLink.cjs"(exports) {
      "use strict";
      var common = require_common();
      var responses = require_responses();
      var commandFactory = require_commandFactory();
      var openExternalLink = (sendCommand) => commandFactory.commandFactory(sendCommand, common.Commands.OPEN_EXTERNAL_LINK, responses.OpenExternalLinkResponse);
      exports.openExternalLink = openExternalLink;
    }
  });

  // node_modules/@discord/embedded-app-sdk/output/commands/openInviteDialog.cjs
  var require_openInviteDialog = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/commands/openInviteDialog.cjs"(exports) {
      "use strict";
      var common = require_common();
      var responses = require_responses();
      var commandFactory = require_commandFactory();
      var openInviteDialog = (sendCommand) => commandFactory.commandFactory(sendCommand, common.Commands.OPEN_INVITE_DIALOG, responses.EmptyResponse);
      exports.openInviteDialog = openInviteDialog;
    }
  });

  // node_modules/@discord/embedded-app-sdk/output/commands/setActivity.cjs
  var require_setActivity = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/commands/setActivity.cjs"(exports) {
      "use strict";
      var common = require_common();
      var responses = require_responses();
      var commandFactory = require_commandFactory();
      ...
      var setActivity = (sendCommand) => commandFactory.commandFactory(sendCommand, common.Commands.SET_ACTIVITY, responses.SetActivityResponse);
      exports.setActivity = setActivity;
    }
  });

  // node_modules/@discord/embedded-app-sdk/output/commands/setConfig.cjs
  var require_setConfig = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/commands/setConfig.cjs"(exports) {
      "use strict";
      var common = require_common();
      var responses = require_responses();
      var commandFactory = require_commandFactory();
      var setConfig = (sendCommand) => commandFactory.commandFactory(sendCommand, common.Commands.SET_CONFIG, responses.SetConfigResponse);
      exports.setConfig = setConfig;
    }
  });

  // node_modules/@discord/embedded-app-sdk/output/utils/compatCommandFactory.cjs
  var require_compatCommandFactory = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/utils/compatCommandFactory.cjs"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      var index = require_lib();
      var Constants = require_Constants();
      var common = require_common();
      function compatCommandFactory({ sendCommand, cmd, response, fallbackTransform, transferTransform = () => void 0 }) {
        const payload = common.ReceiveFramePayload.extend({
          cmd: index.literal(cmd),
          data: response
        });
  ...
  // node_modules/@discord/embedded-app-sdk/output/commands/setOrientationLockState.cjs
  var require_setOrientationLockState = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/commands/setOrientationLockState.cjs"(exports) {
      "use strict";
      var common = require_common();
      var responses = require_responses();
      var compatCommandFactory = require_compatCommandFactory();
      ...
      var setOrientationLockState = (sendCommand) => compatCommandFactory.default({
        sendCommand,
  ...
  // node_modules/@discord/embedded-app-sdk/output/commands/startPurchase.cjs
  var require_startPurchase = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/commands/startPurchase.cjs"(exports) {
      "use strict";
      var common = require_common();
      var responses = require_responses();
      var commandFactory = require_commandFactory();
      var startPurchase = (sendCommand) => commandFactory.commandFactory(sendCommand, common.Commands.START_PURCHASE, responses.StartPurchaseResponse);
      exports.startPurchase = startPurchase;
    }
  });

  // node_modules/@discord/embedded-app-sdk/output/commands/userSettingsGetLocale.cjs
  var require_userSettingsGetLocale = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/commands/userSettingsGetLocale.cjs"(exports) {
      "use strict";
      var common = require_common();
      var responses = require_responses();
      var commandFactory = require_commandFactory();
      var userSettingsGetLocale = (sendCommand) => commandFactory.commandFactory(sendCommand, common.Commands.USER_SETTINGS_GET_LOCALE, responses.UserSettingsGetLocaleResponse);
      exports.userSettingsGetLocale = userSettingsGetLocale;
    }
  });

  // node_modules/@discord/embedded-app-sdk/output/commands/authenticate.cjs
  var require_authenticate = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/commands/authenticate.cjs"(exports) {
      "use strict";
      var schemas = require_schemas();
      var commandFactory = require_commandFactory();
      var authenticate = commandFactory.schemaCommandFactory(schemas.Command.AUTHENTICATE);
      exports.authenticate = authenticate;
    }
  });

  // node_modules/@discord/embedded-app-sdk/output/commands/getActivityInstanceConnectedParticipants.cjs
  var require_getActivityInstanceConnectedParticipants = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/commands/getActivityInstanceConnectedParticipants.cjs"(exports) {
      "use strict";
      var schemas = require_schemas();
      var commandFactory = require_commandFactory();
      var getActivityInstanceConnectedParticipants = commandFactory.schemaCommandFactory(schemas.Command.GET_ACTIVITY_INSTANCE_CONNECTED_PARTICIPANTS);
      exports.getActivityInstanceConnectedParticipants = getActivityInstanceConnectedParticipants;
    }
  });

  // node_modules/@discord/embedded-app-sdk/output/commands/getQuest.cjs
  var require_getQuest = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/commands/getQuest.cjs"(exports) {
      "use strict";
      var schemas = require_schemas();
      var commandFactory = require_commandFactory();
      var getQuest = commandFactory.schemaCommandFactory(schemas.Command.GET_QUEST);
      exports.getQuest = getQuest;
    }
  });

  // node_modules/@discord/embedded-app-sdk/output/commands/getQuestEnrollmentStatus.cjs
  var require_getQuestEnrollmentStatus = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/commands/getQuestEnrollmentStatus.cjs"(exports) {
      "use strict";
      var schemas = require_schemas();
      var commandFactory = require_commandFactory();
      var getQuestEnrollmentStatus = commandFactory.schemaCommandFactory(schemas.Command.GET_QUEST_ENROLLMENT_STATUS);
      exports.getQuestEnrollmentStatus = getQuestEnrollmentStatus;
    }
  });

  // node_modules/@discord/embedded-app-sdk/output/commands/getRelationships.cjs
  var require_getRelationships = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/commands/getRelationships.cjs"(exports) {
      "use strict";
      var schemas = require_schemas();
      var commandFactory = require_commandFactory();
      var getRelationships = commandFactory.schemaCommandFactory(schemas.Command.GET_RELATIONSHIPS);
      exports.getRelationships = getRelationships;
    }
  });

  // node_modules/@discord/embedded-app-sdk/output/commands/getUser.cjs
  var require_getUser = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/commands/getUser.cjs"(exports) {
      "use strict";
      var schemas = require_schemas();
      var commandFactory = require_commandFactory();
      var getUser = commandFactory.schemaCommandFactory(schemas.Command.GET_USER);
      exports.getUser = getUser;
    }
  });

  // node_modules/@discord/embedded-app-sdk/output/commands/initiateImageUpload.cjs
  var require_initiateImageUpload = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/commands/initiateImageUpload.cjs"(exports) {
      "use strict";
      var schemas = require_schemas();
      var commandFactory = require_commandFactory();
      var initiateImageUpload = commandFactory.schemaCommandFactory(schemas.Command.INITIATE_IMAGE_UPLOAD);
      exports.initiateImageUpload = initiateImageUpload;
    }
  });

  // node_modules/@discord/embedded-app-sdk/output/commands/inviteUserEmbedded.cjs
  var require_inviteUserEmbedded = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/commands/inviteUserEmbedded.cjs"(exports) {
      "use strict";
      var schemas = require_schemas();
      var commandFactory = require_commandFactory();
      var inviteUserEmbedded = commandFactory.schemaCommandFactory(schemas.Command.INVITE_USER_EMBEDDED);
      exports.inviteUserEmbedded = inviteUserEmbedded;
    }
  });

  // node_modules/@discord/embedded-app-sdk/output/commands/openShareMomentDialog.cjs
  var require_openShareMomentDialog = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/commands/openShareMomentDialog.cjs"(exports) {
      "use strict";
      var schemas = require_schemas();
      var commandFactory = require_commandFactory();
      var openShareMomentDialog = commandFactory.schemaCommandFactory(schemas.Command.OPEN_SHARE_MOMENT_DIALOG);
      exports.openShareMomentDialog = openShareMomentDialog;
    }
  });

  // node_modules/@discord/embedded-app-sdk/output/commands/questStartTimer.cjs
  var require_questStartTimer = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/commands/questStartTimer.cjs"(exports) {
      "use strict";
      var schemas = require_schemas();
      var commandFactory = require_commandFactory();
      var questStartTimer = commandFactory.schemaCommandFactory(schemas.Command.QUEST_START_TIMER);
      exports.questStartTimer = questStartTimer;
    }
  });

  // node_modules/@discord/embedded-app-sdk/output/commands/requestProxyTicketRefresh.cjs
  var require_requestProxyTicketRefresh = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/commands/requestProxyTicketRefresh.cjs"(exports) {
      "use strict";
      var schemas = require_schemas();
      var commandFactory = require_commandFactory();
      var requestProxyTicketRefresh = commandFactory.schemaCommandFactory(schemas.Command.REQUEST_PROXY_TICKET_REFRESH);
      exports.requestProxyTicketRefresh = requestProxyTicketRefresh;
    }
  });

  // node_modules/@discord/embedded-app-sdk/output/commands/shareInteraction.cjs
  var require_shareInteraction = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/commands/shareInteraction.cjs"(exports) {
      "use strict";
      var schemas = require_schemas();
      var commandFactory = require_commandFactory();
      var shareInteraction = commandFactory.schemaCommandFactory(schemas.Command.SHARE_INTERACTION);
      exports.shareInteraction = shareInteraction;
    }
  });

  // node_modules/@discord/embedded-app-sdk/output/commands/shareLink.cjs
  var require_shareLink = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/commands/shareLink.cjs"(exports) {
      "use strict";
      var schemas = require_schemas();
      var commandFactory = require_commandFactory();
      var shareLink = commandFactory.schemaCommandFactory(schemas.Command.SHARE_LINK);
      exports.shareLink = shareLink;
    }
  });

  // node_modules/@discord/embedded-app-sdk/output/commands/index.cjs
  var require_commands = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/commands/index.cjs"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      var common = require_common();
      var authorize = require_authorize();
      var captureLog = require_captureLog();
      var encourageHardwareAcceleration = require_encourageHardwareAcceleration();
      var getChannel = require_getChannel();
      var getEntitlements = require_getEntitlements();
      var getSkus = require_getSkus();
      var getChannelPermissions = require_getChannelPermissions();
      var getPlatformBehaviors = require_getPlatformBehaviors();
      var openExternalLink = require_openExternalLink();
      var openInviteDialog = require_openInviteDialog();
      var setActivity = require_setActivity();
      var setConfig = require_setConfig();
      var setOrientationLockState = require_setOrientationLockState();
      var startPurchase = require_startPurchase();
      var userSettingsGetLocale = require_userSettingsGetLocale();
      var authenticate = require_authenticate();
      var getActivityInstanceConnectedParticipants = require_getActivityInstanceConnectedParticipants();
      var getQuest = require_getQuest();
      var getQuestEnrollmentStatus = require_getQuestEnrollmentStatus();
      var getRelationships = require_getRelationships();
      var getUser = require_getUser();
      var initiateImageUpload = require_initiateImageUpload();
      var inviteUserEmbedded = require_inviteUserEmbedded();
      var openShareMomentDialog = require_openShareMomentDialog();
      var questStartTimer = require_questStartTimer();
      var requestProxyTicketRefresh = require_requestProxyTicketRefresh();
      var shareInteraction = require_shareInteraction();
      var shareLink = require_shareLink();
  ...
  // node_modules/@discord/embedded-app-sdk/output/error.cjs
  var require_error = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/error.cjs"(exports) {
      "use strict";
  ...
  // node_modules/@discord/embedded-app-sdk/output/utils/getDefaultSdkConfiguration.cjs
  var require_getDefaultSdkConfiguration = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/utils/getDefaultSdkConfiguration.cjs"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
  ...
  // node_modules/@discord/embedded-app-sdk/output/utils/console.cjs
  var require_console = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/utils/console.cjs"(exports) {
      "use strict";
  ...
  // node_modules/@discord/embedded-app-sdk/output/package.json.cjs
  var require_package_json = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/package.json.cjs"(exports) {
      "use strict";
      var version = "2.5.0";
  ...
  // node_modules/@discord/embedded-app-sdk/output/lib/uuid/dist/esm-browser/native.cjs
  var require_native = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/lib/uuid/dist/esm-browser/native.cjs"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
  ...
  // node_modules/@discord/embedded-app-sdk/output/lib/uuid/dist/esm-browser/rng.cjs
  var require_rng = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/lib/uuid/dist/esm-browser/rng.cjs"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      var getRandomValues;
  ...
  // node_modules/@discord/embedded-app-sdk/output/lib/uuid/dist/esm-browser/stringify.cjs
  var require_stringify = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/lib/uuid/dist/esm-browser/stringify.cjs"(exports) {
      "use strict";
      var byteToHex = [];
      for (let i = 0; i < 256; ++i) {
  ...
  // node_modules/@discord/embedded-app-sdk/output/lib/uuid/dist/esm-browser/v4.cjs
  var require_v4 = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/lib/uuid/dist/esm-browser/v4.cjs"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      ...
      function v4(options, buf, offset) {
        ...
        options = options || {};
        const rnds = options.random ?? options.rng?.() ?? rng.default();
        if (rnds.length < 16) {
  ...
  // node_modules/@discord/embedded-app-sdk/output/Discord.cjs
  var require_Discord = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/Discord.cjs"(exports) {
      "use strict";
      var index = require_virtual();
      var index$2 = require_schema();
      var index$1 = require_commands();
      var error = require_error();
      var events = require_events();
      var Constants = require_Constants();
      var getDefaultSdkConfiguration = require_getDefaultSdkConfiguration();
      var console$1 = require_console();
      var _package = require_package_json();
      var common = require_common();
      var v4 = require_v4();
  ...
  // node_modules/@discord/embedded-app-sdk/output/utils/PermissionUtils.cjs
  var require_PermissionUtils = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/utils/PermissionUtils.cjs"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      var BigFlagUtils = require_BigFlagUtils();
  ...
  // node_modules/@discord/embedded-app-sdk/output/lib/decimal.js-light/decimal.cjs
  var require_decimal = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/lib/decimal.js-light/decimal.cjs"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      var MAX_DIGITS = 1e9;
      var defaults = {
  ...
  // node_modules/@discord/embedded-app-sdk/output/utils/PriceConstants.cjs
  var require_PriceConstants = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/utils/PriceConstants.cjs"(exports) {
      "use strict";
  ...
  // node_modules/@discord/embedded-app-sdk/output/utils/PriceUtils.cjs
  var require_PriceUtils = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/utils/PriceUtils.cjs"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      var decimal = require_decimal();
      var PriceConstants = require_PriceConstants();
  ...
  // node_modules/@discord/embedded-app-sdk/output/_virtual/index3.cjs
  var require_index3 = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/_virtual/index3.cjs"(exports) {
      "use strict";
  ...
  // node_modules/@discord/embedded-app-sdk/output/lib/lodash.transform/index.cjs
  var require_lodash = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/lib/lodash.transform/index.cjs"(exports) {
      "use strict";
      var _commonjsHelpers = require_commonjsHelpers();
      var index = require_index3();
      index.__module.exports;
      var hasRequiredLodash_transform;
      function requireLodash_transform() {
        if (hasRequiredLodash_transform) return index.__module.exports;
      ...
      exports.__require = requireLodash_transform;
    }
  });

  // node_modules/@discord/embedded-app-sdk/output/_virtual/index2.cjs
  var require_index22 = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/_virtual/index2.cjs"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      var _commonjsHelpers = require_commonjsHelpers();
      var index = require_lodash();
      var lodash_transformExports = index.__require();
      var transform = /* @__PURE__ */ _commonjsHelpers.getDefaultExportFromCjs(lodash_transformExports);
      exports.default = transform;
    }
  });

  // node_modules/@discord/embedded-app-sdk/output/mock.cjs
  var require_mock = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/mock.cjs"(exports) {
      "use strict";
      var index = require_virtual();
      var BigInteger = require_BigInteger3();
      var index$1 = require_index22();
      var Constants = require_Constants();
      var getDefaultSdkConfiguration = require_getDefaultSdkConfiguration();
      var common = require_common();
  ...
  // node_modules/@discord/embedded-app-sdk/output/lib/tslib/tslib.es6.cjs
  var require_tslib_es6 = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/lib/tslib/tslib.es6.cjs"(exports) {
      "use strict";
      function __rest(s, e) {
        var t = {};
  ...
  // node_modules/@discord/embedded-app-sdk/output/utils/url.cjs
  var require_url = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/utils/url.cjs"(exports) {
      "use strict";
  ...
  // node_modules/@discord/embedded-app-sdk/output/utils/patchUrlMappings.cjs
  var require_patchUrlMappings = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/utils/patchUrlMappings.cjs"(exports) {
      "use strict";
      ...
      function attemptRecreateScriptNode(node, { url: url2, mappings }) {
        const newUrl = attemptRemap({ url: url2, mappings });
        if (url2.toString() !== newUrl.toString()) {
          const newNode = document.createElement(node.tagName);
          newNode.innerHTML = node.innerHTML;
          for (const attr of node.attributes) {
            newNode.setAttribute(attr.name, attr.value);
          }
          newNode.setAttribute("src", attemptRemap({ url: url2, mappings }).toString());
          node.after(newNode);
          node.remove();
        }
      }
  ...
  var require_index = __commonJS({
    "node_modules/@discord/embedded-app-sdk/output/index.cjs"(exports) {
      var Discord = require_Discord();
      var events = require_events();
      var common = require_common();
      var responses = require_responses();
      var Constants = require_Constants();
      var PermissionUtils = require_PermissionUtils();
      var PriceUtils = require_PriceUtils();
      var mock = require_mock();
      var patchUrlMappings = require_patchUrlMappings();
      var { Commands } = common;
      ...
      Object.defineProperty(exports, "RPCCloseCodes", {
        enumerable: true,
        get: function() {
          return Constants.RPCCloseCodes;
        }
      });
      Object.defineProperty(exports, "RPCErrorCodes", {
        enumerable: true,
        get: function() {
          return Constants.RPCErrorCodes;
        }
      });
